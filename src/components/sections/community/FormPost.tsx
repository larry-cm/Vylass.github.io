...
export default function FormPost({ userId, imageUrl, firstName, children }: {
    ...
    const handleKeysStop = (e: React.FormEvent<HTMLInputElement | HTMLDivElement>) => {
        const keysStop = ['Escape', 'Delete', 'Tab']
    ...
    return (
        ...
        >
            <div
                data-anima
                className="flex flex-col order-2 w-full gap-5 p-4 rounded-md shadow-md justify-self-center bg-fondo sm:max-w-xs">
                <Toaster
                ...
                <div className="flex flex-col gap-5 text-base">
                    ...
                    <div className='relative'>
                        <div
                            ...
                            onKeyDown={handleKeysStop}
                            className="border border-neutral-400/80 px-2 pb-4 py-1 rounded w-full h-[3lh] overflow-clip whitespace-pre-wrap break-words outline-none text-break max-w-full"
                        >
                        </div>
                        {
                            <p
